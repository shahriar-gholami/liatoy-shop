...
urlpatterns = [
    ...
    path('special-products/tag/<str:tag_slug>/', views.SpecialProductListView.as_view(), name='special_tag_products'),
    path('products/brand/<str:brand_slug>/', views.BrandProductListView.as_view(), name='special_brand_products'),
    ...
    path('blog/category/<int:pk>/<str:category_slug>/', views.CategoryBlogPostList.as_view(), name='category_post_list'),
